...
# Prefer in-repo pairing-logs; AI-store layout keeps them beside the checkout.
PAIRING = ROOT / "pairing-logs"
if not PAIRING.is_dir():
    PAIRING = ROOT.parent / "pairing-logs"
_ws = Path(r"C:\Users\Gilbert\Documents\Ai app store\pairing-logs")
if not PAIRING.is_dir() and _ws.is_dir():
    PAIRING = _ws
