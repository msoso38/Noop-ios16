...
public enum NoopMetrics {
    ...
    /// Shared shadow geometry for elevated and scenic surfaces.
    public static let shadowRadiusSmall: CGFloat = 6
    public static let shadowRadiusMedium: CGFloat = 8
    public static let shadowRadiusTitle: CGFloat = 10
    public static let shadowRadiusLarge: CGFloat = 12
    public static let shadowOffsetMinimal: CGFloat = 1
    public static let shadowOffsetSmall: CGFloat = 3
    public static let shadowOffsetMedium: CGFloat = 4
